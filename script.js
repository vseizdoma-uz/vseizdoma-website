...
const translations = {
    ru: {
        ...
        promoDesc: 'Есть импортная мебель барокко, рококо, классика? Мы купим её дорого! Оценка за 30 минут, бесплатный вывоз, оплата на месте.',
        promoFeat1: 'Оценка за 30 минут по фото',
        promoFeat2: 'Бесплатный вывоз',
    ...
    uz: {
        ...
        promoDesc: 'Import mebel — barokko, rokoko, klassika bormi? Biz uni qimmat sotib olamiz! 30 daqiqada baholash, bepul olib ketish, joyida to\'lov.',
        promoFeat1: 'Foto orqali 30 daqiqada baholash',
        promoFeat2: 'Bepul olib ketish',
    ...
    en: {
        ...
        promoDesc: 'Have imported baroque, rococo, or classic furniture? We buy it at the best prices! Evaluation in 30 minutes, free pickup, instant payment.',
        promoFeat1: 'Photo evaluation in 30 minutes',
        promoFeat2: 'Free pickup',
